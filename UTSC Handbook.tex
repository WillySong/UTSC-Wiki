...
\begin{itemize}
    ...
    \item Tampons and Pads (FREE): Outside the Health and Wellness Centre there are free tampons and pads in small packages. They also include coupons for more.
    \item Condoms (FREE TOO): There are free condoms (both male and female), lube, and maybe some other things provided by health and wellness centre. It's always good to keep condoms in your bag in case you or a friend needs one in a pinch. Although most people do, don't keep condoms in your wallet. It will wear out the latex and make them prone to breaking.
\end{itemize}
...
Also it is in the right section, apparently it is a HPCS course.
